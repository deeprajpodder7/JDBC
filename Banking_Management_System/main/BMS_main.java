...
import com.banking.bms.WrongpinException;
...
import com.banking.bms.WrongAccnoException;

public class BMS_main {
	static Scanner sc = new Scanner(System.in);
	public static void main(String[] args) throws SQLException, WrongpinException, WrongAccnoException {
		int variable;
		do{
		System.out.println("""
